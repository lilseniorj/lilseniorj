...
|---|---|---|
| ⭐ [CandyDatos](https://candydatos.web.app) | Plataforma de reclutamiento con entrevistas IA en tiempo real (proyecto de tesis) | React · Firebase · Gemini AI |
| [FlowCraft](https://jv-flowcraft.web.app) | Automatizaciones n8n listas para producción: agentes IA, CRM y bots de Telegram | n8n · React · Firebase |
| [AI CV Analyzer](https://github.com/lilseniorj/ai-cv-analyzer) | Analizador de hojas de vida con IA | React · Puter.js |
| [Food Ordering App](https://github.com/lilseniorj/food_ordering) | App de delivery con autenticación de Google | React Native · TypeScript |
| [n8n Email Verifier](https://github.com/lilseniorj/n8n-nodes-verificar-email) | Nodo personalizado de n8n para verificar correos | TypeScript |
| [Platzi News](https://github.com/lilseniorj/Python-Arquitectura-Proyectos-PyPI) | CLI que busca noticias y responde preguntas con OpenAI | Python |
...
[![Portafolio](https://img.shields.io/badge/Portafolio-jesusvargas.web.app-57e6a8?style=flat-square)](https://jesusvargas.web.app)
...
![Stats de GitHub](https://github-readme-stats.vercel.app/api?username=lilseniorj&show_icons=true&theme=tokyonight&hide_border=true&bg_color=0a0e14)
